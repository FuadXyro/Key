...
/**************** TIME *******************/
 let wib = moment.tz('Asia/Jakarta').format('HH:mm:ss')
    ...
    let waktuwita = `${wibh} H ${wibm} M ${wibs} S`
        ...
        let link = 'https://wa.me/stickerpack/meta-avatar'
       let thumb = 'https://telegra.ph/file/eda1592eda5434617b05d.jpg' 

        await conn.reply(m.chat, caption, m, { mentions: [m.sender], contextInfo: { forwardingScore: 9999, isForwarded: true, externalAdReply :{ mediaType: 1, mediaUrl: thumb, title: `${namebot}`, body: `By FuadXy`, thumbnail: { url: thumb }, thumbnailUrl: thumb, sourceUrl: link, renderLargerThumbnail: true }}})
        
        // Sound
        var vn = "https://raw.githubusercontent.com/FuadXyro/Audio/main/sound2.mp3"
