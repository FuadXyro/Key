...
let pp = 'https://telegra.ph/file/e40b8fd257843808026ef.jpg'
const potion = 500
const Sgold = 3000
const Bgold = 6000
const Bstring = 500
...
`.trim()
    try {
                ...
                case 'buy':
                    switch (_type) {
                        ...
                        case 'fishingrod':
                            ...
                            break
                        default:
                            return await conn.reply(m.chat, Kchat, m, { contextInfo: { isForwarded: true, forwardingScore: 9999, externalAdReply :{ mediaType: 1, mediaUrl: pp, title: `${htki} S H O P ${htka}`, body: '🌱┊ RPG WhatsApp Bot', thumbnail: { url: pp }, thumbnailUrl: pp, renderLargerThumbnail: true }}})
                    }
                    break
                case 'sell':
                    switch (_type) {
        ...
        await conn.reply(m.chat, Kchat, m, { contextInfo: { isForwarded: true, forwardingScore: 9999, externalAdReply :{ mediaType: 1, mediaUrl: pp, title: `${htki} S H O P ${htka}`, body: '🌱┊ RPG WhatsApp Bot', thumbnail: { url: pp }, thumbnailUrl: pp, renderLargerThumbnail: true }}})
        console.log(e)
        if (DevMode) {
