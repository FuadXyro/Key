...
Timeout *${(timeout / 1000).toFixed(2)} detik*
 ...
 ${json.soal}
    `.trim()
    let mesOtp = await conn.reply(m.chat, caption, m, { mentions: [m.sender], contextInfo: { forwardingScore: 9999, isForwarded: true, externalAdReply :{ mediaType: 1, mediaUrl: thumb, title: `${namebot}`, body: `By FuadXy`, thumbnail: { url: pp }, thumbnailUrl: pp, sourceUrl: null, renderLargerThumbnail: true }}})
    conn.regmail[id] = [
        mesOtp,
        json, poin,
        setTimeout(() => {
