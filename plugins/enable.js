...
`
  ...
  switch (type) {
    ...
    case 'groupmode':
      ...
      global.opts['groupmode'] = isEnable
      break
    ...
    default:
      if (!/[01]/.test(command)) return await conn.reply(m.chat, fxy, m, { contextInfo: { mentionedJid: [m.sender], forwardingScore: 9999, isForwarded: true, externalAdReply: { mediaType: 1, mediaUrl: thumb, title: ']=======❏ OPTIONS ❏=======[', thumbnail: { url: thumb }, thumbnailUrl: thumb, sourceUrl: false, renderLargerThumbnail: true }}})
      throw false
  }
