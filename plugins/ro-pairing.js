...
const { useMultiFileAuthState, DisconnectReason, makeInMemoryStore, jidNormalizedUser, makeCacheableSignalKeyStore, PHONENUMBER_MCC } = SiBail
...
conn,
   ...
   store.bind(bajing.ev)
    ...
    if (conn.user.jid == numJadibot) return m.reply('Tidak bisa membuat Bot pada user jadibot!');
