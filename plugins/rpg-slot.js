...
*${WinOrLose}* *${Hadiah}*
`
await conn.reply(m.chat, fxy, m, { contextInfo: { isForwarded: false, forwardingScore: 9999, externalAdReply :{ mediaType: 1, mediaUrl: kled, title: `🎰VIRTUAL SLOTS🎰`, body: '🌱┊ RPG WhatsApp Bot', thumbnail: { url: kled }, thumbnailUrl: kled, renderLargerThumbnail: true }}})
