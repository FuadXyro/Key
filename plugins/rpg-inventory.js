...
let handler = async (m, { conn }) => {
  ...
  let kled = 'https://telegra.ph/file/e43e640a9d4a94cc421ad.jpg'
...
`.trim()
await conn.reply(m.chat, caption, m, { contextInfo: { isForwarded: false, forwardingScore: 9999, externalAdReply :{ mediaType: 1, mediaUrl: kled, title: `${htki} I N V E N T O R Y ${htka}`, body: '🌱┊ RPG WhatsApp Bot', thumbnail: { url: kled }, thumbnailUrl: kled, renderLargerThumbnail: true }}})
}
