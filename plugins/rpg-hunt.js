let handler = async (m, {
    ...
    if (new Date - global.db.data.users[m.sender].lasthunt > 1200000) {
        ...
        let pp = 'https://telegra.ph/file/d4488efdd7d7befc4b648.jpg'
...
> Tiket Coin +1`
        await conn.reply(m.chat, pesan, m, { contextInfo: { mentionedJid: [m.sender], forwardingScore: 9999, isForwarded: true, externalAdReply: { mediaType: 1, mediaUrl: pp, title: '⌂ H U N T E R', thumbnail: { url: pp }, thumbnailUrl: pp, sourceUrl: false, renderLargerThumbnail: true }}})
